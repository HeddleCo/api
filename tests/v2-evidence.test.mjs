...
import { CheckEvidenceSummary_Outcome as Outcome } from '../packages/typescript/dist/v1alpha2/activity_pb.js';
import { signCheckEvidence, projectCheckEvidence, prepareCheckAcknowledgement } from '../packages/typescript/dist/v1alpha2/evidence.js';
