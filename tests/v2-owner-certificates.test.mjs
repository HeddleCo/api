...
import { canonicalMintRootAttachment, mintRootAttachmentSigningDigest, signMintRootAttachment, verifyMintRootAttachment } from '../packages/typescript/dist/v1alpha2/owner-certificates.js';
