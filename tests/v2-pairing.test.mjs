...
import { BeginPairingRequestSchema, CompletePairingRequestSchema, BrowserPairingCompletionBindingSchema } from '../packages/typescript/dist/v1alpha2/identity_pb.js';
import { signBrowserPairingInitiation, signBrowserPairingCompletion, verifyBrowserPairingCompletion } from '../packages/typescript/dist/v1alpha2/pairing.js';
