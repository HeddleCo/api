...
def audit_new_descriptor(decoded: str) -> None:
    ...
    # RPCs now inherit SHIPPED; CreateSignupInvite, RegisterGitHubInstallation,
    # and the two remote-link management RPCs remain contract-first until their
    # Weft handlers land).
    assert decoded.count("maturity: SERVICE_MATURITY_PLANNED") == 14
