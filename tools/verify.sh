...
node --test tests/v2-stream.test.mjs tests/v2-client.test.mjs tests/v2-genesis.test.mjs tests/v2-initial-source.test.mjs tests/v2-collaboration.test.mjs tests/v2-boundary-acceptance.test.mjs
